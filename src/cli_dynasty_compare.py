...
async def main(
    side_a: List[str], side_b: List[str], ppr: float, super_flex: bool, number_of_teams: int
) -> None:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=bool,
        default=True,
        help="Is this a super flex league? (True/False). Default is True."),
    parser.add_argument("--number-of-teams", type=int, default=12, help="Number of teams in the league. Default is 12."  )
